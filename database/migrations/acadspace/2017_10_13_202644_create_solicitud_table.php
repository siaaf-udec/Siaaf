...
class CreateSolicitudTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('acadspace')->create('TBL_Solicitud', function (Blueprint $table) {
            ...
            $table->string('SOL_Guia_Practica',50);
            $table->string('SOL_Dias',150)->nullable();
            $table->integer('FK_SOL_Id_Software')->unsigned()->nullable();
            $table->string('SOL_Grupo',50);
