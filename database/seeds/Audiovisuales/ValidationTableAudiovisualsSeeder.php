...
class ValidationTableAudiovisualsSeeder extends Seeder
{
    ...
    {
        $preguntas = [
            ['VAL_PRE_Nombre' => ' ¿Número de préstamos que puede realizar el usuario?', 'VAL_PRE_Valor' => '3' ],
            ...
            ['VAL_PRE_Nombre' => ' ¿Máximo de días que pueden reservar un artículo?', 'VAL_PRE_Valor' => '3' ],
            ['VAL_PRE_Nombre' => ' ¿Máximo de horas que pueden reservar un kit? ', 'VAL_PRE_Valor' => '4' ],
            ...
            ['VAL_PRE_Nombre' => ' ¿Numero de horas maximas para articulo con tiempo libre?', 'VAL_PRE_Valor' => '4' ],
            ['VAL_PRE_Nombre' => ' ¿Numero de horas maximas para articulo con tiempo asignado?', 'VAL_PRE_Valor' => '2' ],
            ...
            ['VAL_PRE_Nombre' => ' ¿Numero de dias habiles para escoger fecha de reserva?', 'VAL_PRE_Valor' => '3' ],
            ['VAL_PRE_Nombre' => ' ¿Numero de dias de anticipación para reservar kit o articulo?', 'VAL_PRE_Valor' => '3' ],
        ];
