...
class PermissionGesapSeeder extends Seeder
{
    ...
    {
        Permission::insert([
            ['name'=>'Create_User_Gesap',
             'display_name'=>'Crear Usuarios',
             'description'=>'Permite la creacion de nuevos usuarios de la plataforma',
             'module_id'=>'7'],
            ['name'=>'Assing_permission_Gesap',
             'display_name'=>'Asignar Permisos',
             'description'=>'Asigna los permisos a los usuarios existentes',
             'module_id'=>'7'],
            ...
            ['name'=>'See_All_Project_Gesap',
             'display_name'=>'Ver todos los Anteproyectos',
             'description'=>'Listar todos los proyectos creados en la plataforma',
             'module_id'=>'7'],
            ['name'=>'Report_Gesap',
