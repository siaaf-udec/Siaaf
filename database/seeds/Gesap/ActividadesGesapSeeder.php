...
class ActividadesGesapSeeder extends Seeder
{
    ...
    public function run()
    {
        Mctr008::insert([
            ...
            ['MCT_Actividad'=>'Requisitos Específicos', 'MCT_Descripcion'=>'Esta sección contiene los requisitos a un nivel de detalle suficiente como para permitir a los diseñadores diseñar un sistema que satisfaga estos requisitos, y que permita al equipo de pruebas planificar y realizar las pruebas que demuestren si el sistema satisface, o no, los requisitos. Todo requisito aquí especificado describirá comportamientos externos del sistema, perceptibles por parte de los usuarios, operadores y otros sistemas.', 'FK_Id_Formato'=>'2'],
