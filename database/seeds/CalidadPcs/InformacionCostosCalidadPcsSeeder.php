...
class InformacionCostosCalidadPcsSeeder extends Seeder
{
    ...
    public function run()
    {
        $costos = [
            ...
            [ 'CPCI_Abreviatura' => 'EAC','CPCI_Nombre' => 'Estimación a la Conclusión', 'CPCI_Definicion' => 'El costo total previsto de completar todo el trabajo, expresado como la suma del costo real a la fecha y la estimación hasta la conclusión.', 'CPCI_Uso' => 'Si se espera que el CPI sea el mismo para el resto del proyecto, se puede calcular EAC con la fórmula: ', 'CPCI_Formula' => 'EAC = BAC/CPI', 'CPCI_Interpretacion' => '' ],
            [ 'CPCI_Abreviatura' => 'EAC','CPCI_Nombre' => 'Estimación a la Conclusión', 'CPCI_Definicion' => 'El costo total previsto de completar todo el trabajo, expresado como la suma del costo real a la fecha y la estimación hasta la conclusión.', 'CPCI_Uso' => 'Si el trabajo futuro se va a realizar según la tasa planificada, utilizar: ', 'CPCI_Formula' => 'EAC = AC + BAC – EV', 'CPCI_Interpretacion' => '' ],
            [ 'CPCI_Abreviatura' => 'EAC','CPCI_Nombre' => 'Estimación a la Conclusión', 'CPCI_Definicion' => 'El costo total previsto de completar todo el trabajo, expresado como la suma del costo real a la fecha y la estimación hasta la conclusión.', 'CPCI_Uso' => 'Si el plan inicial ya no fuera viable, utilizar: ', 'CPCI_Formula' => 'EAC = AC + ETC ascendente.', 'CPCI_Interpretacion' => '' ],
            [ 'CPCI_Abreviatura' => 'EAC','CPCI_Nombre' => 'Estimación a la Conclusión', 'CPCI_Definicion' => 'El costo total previsto de completar todo el trabajo, expresado como la suma del costo real a la fecha y la estimación hasta la conclusión.', 'CPCI_Uso' => 'Si tanto CPI como SPI tienen influencia sobre el trabajo restante, utilizar:', 'CPCI_Formula' => 'EAC = AC + [(BAC – EV)/ (CPI x SPI)]', 'CPCI_Interpretacion' => '' ],
            [ 'CPCI_Abreviatura' => 'ETC','CPCI_Nombre' => 'Estimación hasta la Conclusión', 'CPCI_Definicion' => 'El costo previsto para terminar todo el trabajo restante del proyecto.', 'CPCI_Uso' => 'Si se asume que el trabajo está avanzando de acuerdo con el plan, el costo para completar el trabajo autorizado restante se puede calcular mediante la utilización de: ', 'CPCI_Formula' => 'ETC = EAC – AC', 'CPCI_Interpretacion' => '' ],
            [ 'CPCI_Abreviatura' => 'TCPI','CPCI_Nombre' => 'Índice de Desempeño del Trabajo por Completar', 'CPCI_Definicion' => 'Medida del desempeño del costo que se debe alcanzar con los recursos restantes a fin de cumplir con un objetivo de gestión especificado, expresada como la tasa entre el costo para culminar el trabajo pendiente y el presupuesto restante.', 'CPCI_Uso' => 'La eficiencia que es preciso mantener para cumplir el plan.', 'CPCI_Formula' => 'TCPI = (BAC – EV)/(BAC – AC)', 'CPCI_Interpretacion' => 'Mayor que 1,0 = Más difícil de completar. Exactamente 1,0 = Igual. Menor que 1,0 = Más fácil de completar.' ],
            [ 'CPCI_Abreviatura' => 'TCPI','CPCI_Nombre' => 'Índice de Desempeño del Trabajo por Completar', 'CPCI_Definicion' => 'Medida del desempeño del costo que se debe alcanzar con los recursos restantes a fin de cumplir con un objetivo de gestión especificado, expresada como la tasa entre el costo para culminar el trabajo pendiente y el presupuesto restante.', 'CPCI_Uso' => 'La eficiencia que es preciso mantener para completar la EAC actual.', 'CPCI_Formula' => 'TCPI = (BAC – EV)/(EAC – AC)', 'CPCI_Interpretacion' => ' Mayor que 1,0 = Más difícil de completar. Exactamente 1,0 = Igual. Menor que 1,0 = Más fácil de completar.' ]
        ];
