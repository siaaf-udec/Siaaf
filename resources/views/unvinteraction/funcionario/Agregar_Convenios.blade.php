...
@section('content')
    ...
    <div class="col-md-12">
        @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-book-open', 'title' => 'FORMULARIO DE REGISTRO DE CONVENIOS'])

            
            <div class="row">
                <div class="col-md-7 col-md-offset-2">
                    <div class="form-body">
                            {!! Form::open (['method'=>'POST', 'route'=> ['Registro_Convenio.store'], 'role'=>"form"]) !!}
