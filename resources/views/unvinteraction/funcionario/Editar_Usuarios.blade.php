            ...
            <div class="row">
                <div class="col-md-7 col-md-offset-2">
                    ...
                    <div class="form-body">
                        ...
                        {!! Form::model ($usuario, ['method'=>'PATCH', 'route'=> ['Mod_Usuarios.update', $usuario->PK_Usuario], 'role'=>"form"]) !!}
                       ...
                       {!! Field:: text('Nombre',null,['label'=>'Nombre(s)','class'=> 'form-control', 'autofocus', 'maxlength'=>'40','autocomplete'=>'off'],
                        ...
                        <div class="form-group">
                                                <label>Estado</label>
                                                <select class="form-control" name="FK_TBL_Estado_Usuario">
                                                    @if($opciont)
                                                    @foreach($opciont as $row)
                                                    <option value="{{ $row->PK_Estado_Usuario }}">{{ $row->Estado }}</option>
                                                    @endforeach
                                                    @endif
