...
<a class="dt-button buttons-print btn btn-circle btn-icon-only btn-default tooltips t-print" tabindex="0" aria-controls="example-table-ajax" onclick=" location.href='http://localhost/siaaf/public/index.php/interaccion-universitaria/Agregar_Usuarios' " title="Agregar Participante">
        <span>
...
<a class="dt-button buttons-print btn btn-circle btn-icon-only btn-default tooltips t-print" tabindex="0" aria-controls="example-table-ajax" onclick=" location.href='http://localhost/siaaf/public/index.php/interaccion-universitaria/Agregar_Usuarios' " title="Agregar empresa">
        <span>
            <i class="fa fa-calendar-plus-o"></i>
        </span>
    </a>
...
jQuery(document).ready(function () {
    ...
    table.DataTable({
       ...
       columns:[
           ...
           {data: 'Ubicacion', searchable: true},
           ...
           {   data:"PK_Documentacion",
               ...
               render: function ( data, type, full, meta ) {
                 return '<a href="" class="btn btn-simple btn-blue btn-icon edit"><i class="fa fa-cloud-download"></i></a>';
                },
    ...
    table.DataTable({
       ...
       columns:[
           ...
           {   data:"PK_Empresas_Participantes",
               ...
               className: '',   
               render: function ( data, type, full, meta ) {
                 return '<a href="" class="btn btn-simple btn-warning btn-icon edit"><i class="icon-pencil"></i></a>';
                },
                responsivePriority:2
