...
@section('content')
    ...
    <a class="dt-button buttons-print btn btn-circle btn-icon-only btn-default tooltips t-print" tabindex="0" aria-controls="example-table-ajax" onclick=" location.href='http://localhost/siaaf/public/index.php/interaccion-universitaria/Agregar_Convenios' " title="Agregar Convenio">
        <span>
       ...
       columns:[
           ...
           {   data:"PK_Convenios",
               ...
               render: function ( data, type, full, meta ) {
                 return '<a href="/siaaf/public/index.php/interaccion-universitaria/Editar_Convenios/'+data+'" class="btn btn-simple btn-warning btn-icon edit"><i class="icon-pencil"></i></a><a href="/siaaf/public/index.php/interaccion-universitaria/Documentos_Convenios/'+data+'" class="btn btn-simple btn-success btn-icon edit"><i class="icon-notebook"></i></a>';
                },
