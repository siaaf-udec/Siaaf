...
jQuery(document).ready(function () {
    ...
    table.DataTable({
       ...
       columns:[
           {data: 'DT_Row_Index'},
           {data: 'PK_EMPS_Empresa', "visible": true, name:"documento" },
           {data: 'EMPS_Nombre_Empresa', searchable: true},
           {data: 'EMPS_Razon_Social', searchable: true},
           {data: 'EMPS_Telefono',searchable: true},
           {data: 'EMPS_Direccion',searchable: true},
