    ...
    jQuery(document).ready(function() {
        ...
        columns = [
            {data: 'DT_Row_Index'},
                ...
                {data: 'convenio_estados.ETAD_Estado',searchable: true,name:"convenio_estado.ETAD_Estado"},
                {data: 'convenio_sedes.SEDE_Sede',searchable: true,name:"convenio_sede.SEDE_Sede"},
                {data: 'action',
                name: 'action',
                title: 'Acciones',
                orderable: false,
