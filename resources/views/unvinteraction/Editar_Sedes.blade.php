                ...
                <div class="col-md-7 col-md-offset-2">
                    <div class="form-body">
                        ...
                        <div class="form-wizard">
                           {!! Field:: text('Sede',$Sede->Sede,['label'=>'sede', 'class'=> 'form-control', 'autofocus', 'maxlength'=>'40','autocomplete'=>'off'],['help' => 'Nombre de la sede','icon'=>'fa fa-line-chart'] ) !!}
...
jQuery(document).ready(function () {
    ...
    var crearConvenio = function () {
            return{
                init: function () {
                    var route = '{{ route('Modificar_Sedes.Modificar_Sedes',[$Sede->PK_Sede]) }}';
                    var type = 'POST';
                  ...
                  ;
                    ...
                    if (request.status === 200 && xhr === 'success') {
                        ...
                        var route = '{{ route('Sedes_Ajax.Sedes_Ajax') }}';
