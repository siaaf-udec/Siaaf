...
ComponentsSelect2.init();
    ...
    var form = $('#form-Agregar-Convenio');
        ...
        var crearConvenio = function() {
            return {
                init: function() {
                    var route = '{{ route('registrarEvaluacion.registrarEvaluacion',[$id,$convenio,$N1]) }}';
                    var type = 'POST';
...
ComponentsSelect2.init();
  ...
  $('.atras').on('click', function (e) {
        ...
        var crearConvenio = function() {
            return {
                init: function() {
                    var route = '{{ route('registrarEvaluacion.registrarEvaluacion',[$id,$convenio,$N2]) }}';
                    var type = 'POST';
                    var async = async || false;
