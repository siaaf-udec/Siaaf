<div class="col-md-12">
    @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-book-open', 'title' => 'Formulario de reportes Proyecto'])
        @slot('actions', [
            'link_cancel' => [
                'link' => '',
    ...
    $(document).ready(function () {
       ...
       FormValidationMd.init(form, false, false, crearRepo());
        ...
        $('.button-rEstado').on('click', function (e) {
            ...
            $.ajax({}).done(function () {
                window.open('{{ route('AnteproyectosGesap.ReportesEspProyecto') }}' + '/'+ $id);
            });
        });
        ...
        $('.button-rFecha').on('click', function (e) {
            ...
            $.ajax({}).done(function () {
                window.open('{{ route('AnteproyectosGesap.ReportesEspProyectoF') }}' + '/'+ $id + '/' + $id2 );
            });
        });
        ...
        $('.button-rPalabrasClave').on('click', function (e) {
            ...
            $.ajax({}).done(function () {
                window.open('{{ route('AnteproyectosGesap.ReportesEspProyectoPC') }}' + '/'+ $id );
            });
        });
        ...
        $('.button-rProfesor').on('click', function (e) {
            ...
            $.ajax({}).done(function () {
                window.open('{{ route('AnteproyectosGesap.ReportesEspProyectoPE') }}' + '/'+ $id+'/'+$id2 );
            });
        });
