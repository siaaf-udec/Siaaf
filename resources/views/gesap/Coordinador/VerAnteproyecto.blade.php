<div class="col-md-12">
    @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-book-open', 'title' => 'Anteproyecto De Grado Extensión Facatativa'])
            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="form-body">
                    <div class="row">
                            ...
                            {!! Field:: textArea('NPRY_Titulo',$datos[0]['NPRY_Titulo'],['label'=>'TITULO:','readonly','class'=> 'form-control', 'autofocus','autocomplete'=>'off'],
