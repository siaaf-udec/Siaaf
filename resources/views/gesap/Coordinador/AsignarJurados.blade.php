<div class="col-md-12">
    @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-book-open', 'title' => 'Formulario de actualización de Jurados de Anteproyecto de grado'])
    ...
    $(document).ready(function () {
        ...
        columns = [
            ...
            {data: 'Correo', name: 'Correo'},
             ...
             {
                defaultContent: '@permission('GESAP_ADMIN_ADD_JUDMENT')<a href="javascript:;" title="Asignar" class="btn btn-simple btn-warning btn-icon crear"><i class="icon-plus"></i></a>@endpermission' ,
                data: 'action',
                name: 'action',
                title: 'Acciones',
                orderable: false,
