                    ...
                    <div class="form-body">
                        ...
                        <div class="tab-content">
                            <div class="alert alert-danger display-none">
                                ...
                                Errores.Por favor revisar nuevamente
                            </div>
                            <div class="alert alert-success display-none">
                                <button class="close" data-dismiss="alert"></button>
                                La asignacion ha sido satisfactoria
                            </div>
                            ...
                            <div class="tab-pane" id="tab3">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-4 col-lg-4">
                                        {!! Field::tel('duracion',$anteproyecto->NPRY_Duracion,
                                    ...
                                    <div class="col-xs-12 col-md-12 col-lg-12" id="file">
                                        <div class="form-md-line-input" style="margin: 0 0 35px;">
                                            <div class="fileinput-new input-icon" data-provides="fileinput">
												...
												<input type="file" name="Min" class="other-file" id="Min"  accept="application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf"> </span>
                                                    <a href="javascript:;"
