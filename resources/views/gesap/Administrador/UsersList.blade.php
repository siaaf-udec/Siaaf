...
@section('content')
    @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-frame', 'title' => 'Portlet'])
        ...
        <div class="col-md-12">
            @component('themes.bootstrap.elements.tables.datatables', ['id' => 'lista-users'])
...
jQuery(document).ready(function () {
    ...
    table.DataTable({
       ...
       columns:[
           {data: 'DT_Row_Index'},
           {data: 'PK_SRS_Cedula' },
           {data: 'SRS_Nombre', searchable: true},
           {data: 'SRS_Apellido',searchable: true},
