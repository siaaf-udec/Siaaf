...
<script>
    jQuery(document).ready(function () {
        ...
        columns = [
            ...
            {data: 'PK_BVCS_IdObservacion', name: "PK_BVCS_IdObservacion", "visible": false},
            {data: 'BVCS_Observacion', name: "BVCS_Observacion", className: 'none', searchable: true},
            {
                data: function (data, type, dataToSet) {
                    ...
                    if (data.encargado != null)
                        ...
                        return "SIN ASIGNAR"
                }, name: "Jurado", searchable: true
            },
            {
                data: 'respuesta.RPST_RMin', name: "RPST_RMin",
            ...
            {
                data: 'respuesta.RPST_Requerimientos', name: "RPST_Requerimientos",
                render: function (data, type, full, meta) {
                    if (data != null) {
                        if (data == "NO FILE") {
                            return "NO APLICA";
