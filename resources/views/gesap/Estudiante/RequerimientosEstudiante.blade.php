       ...
       'link_cancel' => [
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                @permission('GESAP_STUDENT_VER_ACTIVIDADES')<a href="javascript:;"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        url = '{{ route('EstudianteGesap.VerRequerimientosList') }}'+'/'+idp;
        ...
        columns = [
            ...
            {
                defaultContent: '@permission('GESAP_STUDENT_ADD_ACTIVIDAD')<a href="javascript:;" title="Subir Actividad" class="btn btn-simple btn-warning btn-icon Actividad"><i class="icon-plus"></i></a>@endpermission' ,
                data: 'action',
                name: 'action',
                title: 'Acciones',
                orderable: false,
