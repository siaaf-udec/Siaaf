...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        columns = [
            ...
            {
                defaultContent: '@permission('VER_LIBRO_ACTIVIDADES')<a href="javascript:;" title="Subir Actividad" class="btn btn-simple btn-warning btn-icon Actividad"><i class="icon-plus"></i></a>@endpermission' ,
                data: 'action',
                name: 'action',
                title: 'Acciones',
                orderable: false,
