...
<head>
  ...
  @font-face {
	...
	/*Features*/
	h1.features{text-align: center; border-bottom:1px solid #ccc; font-family:fantasy, sans-serif; text-transform: uppercase;}
	.feature{float:center; width:100%;}
	.feature h2{font-size:1.1em; text-transform: uppercase;}
    .feature p{color:#555;}
	.feature:nth-child(even){float:right;}
    .final{text-align: center; border-bottom:1px solid #ccc; font-family:fantasy, sans-serif; text-transform: uppercase;}
     /* table */
...
<body>
    ...
    <img src="{{ base_path('public/css/LogoUDEC.png')}}">
        ...
        <p class="line">Fecha : {{$fecha}} </p>
          @if($n==1)
        <a  href="{{ route('AnteproyectosGesap.ReportesProyecto') }}/ 2">Descargar</a>
        @endif
