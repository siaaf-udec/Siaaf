...
<body>
    ...
    <h2>Se le informa que fue asignado como Desarrollador el estudiante :</h2>
    <h1> {{$name}}</h1>
    <h2> Al Anteproyecto : {{$ante}}</h2>
    <h2> Recuerde confirmar esta Asignación en la plataforma </h2>
