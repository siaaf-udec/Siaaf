...
@section('content')
    <div class="col-md-12">
        @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-frame', 'title' => 'Control de Acceso'])
                ...
                <div class="col-md-12">
                    <div class="actions">
                        <a href="javascript:;" class="btn btn-simple btn-success btn-icon register"><i
                                    class="fa fa-chevron-circle-right"></i>Registrar Ingreso</a>
...
@push('functions')
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            table = $('#listaUsuarios');
            url = "{{ route('administrative.user.data')}}";
            columns = [
            ...
            $(".create").on('click', function (e) {
                e.preventDefault();
                var route_create = '{{ route('administrative.user.create') }}';
                $(".content-ajax").load(route_create);
            });

            $(".register").on('click', function (e) {
                e.preventDefault();
                var route_create = '{{ route('administrative.user.register') }}';
                $(".content-ajax").load(route_create);
            });
