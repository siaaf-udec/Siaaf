...
@section('title', trans('financial.cash.title'))

@section('page-title', trans('financial.cash.index.title'))

@section('page-description', trans('financial.cash.index.description'))
