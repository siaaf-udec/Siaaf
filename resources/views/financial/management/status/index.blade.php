...
@section('title', trans('financial.management.status.title'))

@section('page-title', trans('financial.management.status.index.title'))

@section('page-description', trans('financial.management.status.index.description'))
