...
@section('page-title', 'Solicitud de Supletorio')

@section('page-description', 'solicitud y verificación del recurso')

@section('content')
    <div class="col-md-12">
        @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-layers', 'title' => 'Solicitar Supletorio'])
            <div class="row">
                <div class="col-md-12">
    ...
    <div class="col-md-12">
        @if(session('subject'))
            @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-layers', 'title' => 'Mis Solicitudes de Supletorios'])
