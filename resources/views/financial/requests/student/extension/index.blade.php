...
@section('page-title', trans('financial.extension.index.title'))

@section('page-description', trans('financial.extension.index.description'))

@section('content')
    <div class="col-md-12" id="app">
        <student-extension-request-index></student-extension-request-index>
    </div>
@endsection
