...
@section('page-title', trans('financial.extension.show.title'))

@section('page-description', trans('financial.extension.show.description'))

@section('content')
    <div class="col-md-12" id="app" data-source="{{ $id }}">
        <student-extension-request-show></student-extension-request-show>
    </div>
@endsection
