...
@section('page-title', trans('financial.add-sub.create.title'))

@section('page-description', trans('financial.add-sub.create.description'))

@section('content')
    <div class="col-md-12" id="app">
        <student-add-sub-request-create></student-add-sub-request-create>
    </div>
@endsection
