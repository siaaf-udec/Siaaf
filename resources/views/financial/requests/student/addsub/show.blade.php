...
@section('page-title', trans('financial.add-sub.show.title'))

@section('page-description', trans('financial.add-sub.show.description'))

@section('content')
    <div class="col-md-12" id="app" data-source="{{ $id }}">
        <student-add-sub-request-show></student-add-sub-request-show>
    </div>
@endsection
