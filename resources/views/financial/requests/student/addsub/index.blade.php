...
@section('page-title', 'Solicitud de Adción o Cancelación de Materias')

@section('page-description', 'solicitud y verificación del recurso')

@section('content')
    <div class="col-md-12">
        @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-layers', 'title' => 'Solicitud de Adción o Cancelación de Materias'])
            <div class="row">
                <div class="col-md-12">
                    {{ Form::open(['role' => 'form', 'id' => 'financial-form-extension', 'route' => 'financial.requests.student.add.sub.store']) }}
                        <div class="form-body">
    ...
    <div class="col-md-12">
        @if(session('subject'))
            @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-layers', 'title' => 'Mis Solicitudes de Adición o Cancelación de Materias'])
