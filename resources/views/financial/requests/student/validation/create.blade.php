...
@section('page-title', trans('financial.validation.create.title'))

@section('page-description', trans('financial.validation.create.description'))

@section('content')
    <div class="col-md-12" id="app">
        <student-validation-request-create></student-validation-request-create>
    </div>
@endsection
