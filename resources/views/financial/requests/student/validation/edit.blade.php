...
@section('page-title', trans('financial.validation.edit.title'))

@section('page-description', trans('financial.validation.edit.description'))

@section('content')
    <div class="col-md-12" id="app" data-source="{{ isset($id) ? $id : 0}}">
        <student-validation-request-edit></student-validation-request-edit>
    </div>
@endsection
