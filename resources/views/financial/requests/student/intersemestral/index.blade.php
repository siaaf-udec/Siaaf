...
@section('page-title', 'Solicitud de Intersemestral')

@section('page-description', 'solicitud y verificación del recurso')

@section('content')
    <div class="col-md-12">
        @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-layers', 'title' => 'Solicitud de Intersemestral'])
            <div class="row">
                <div class="col-md-12">
                    {{ Form::open(['role' => 'form', 'id' => 'financial-form-extension', 'route' => 'financial.requests.student.inter.store']) }}
                        <div class="form-body">
    ...
    <div class="col-md-12">
        @if(session('subject'))
            @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-layers', 'title' => 'Mis Solicitudes de Intersemestrales'])
