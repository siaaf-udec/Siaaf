...
@section('page-title', trans('financial.intersemestral.show.title'))

@section('page-description', trans('financial.intersemestral.show.description'))

@section('content')
    <div class="col-md-12" id="app" data-source="{{ $id }}">
        <student-intersemestral-request-show></student-intersemestral-request-show>
    </div>
@endsection
