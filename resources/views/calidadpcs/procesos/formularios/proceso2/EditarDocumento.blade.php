    ...
    @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-book-open', 'title' => 'Etapa de planificacion:'])
        ...
        <h4 style="margin-top: 0px;">Editar proceso: Desarrollar plan para la dirección del proyecto.</h4>
            ...
            <div class="col-md-10 col-md-offset-1">
                {!! Form::model([[$idProceso],[$infoProceso],[$idProyecto],[$integrantes]],['id'=>'form_update_proyecto', 'url' => '/forms']) !!}
                    <div class="form-body">
                        <div class="row">
                            <h3>Informacion del proceso</h3><br>
                                <div class="col-md-12">
                                    ...
                                    {!! Field::textArea('Alcance',$infoProceso['CPPD_Alcance'],['label' => 'Alcance:', 'required', 'auto' => 'off', 'max' => '500', "rows" => '2'],
                ...
                <div class="">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                   {!! Field:: text('Requerimiento',null,['label'=>'Requerimiento:','required', 'max' => '100', 'class'=> 'form-control', 'autofocus','autocomplete'=>'off'],
                                    ['help' => 'Digite el nombre del requerimiento.', 'icon' => 'fa fa-tag'] ) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                {!! Field:: hidden ('idRequerimiento') !!}
                                   ...
                                   {!! Field:: text('Requerimiento_edit',null,['label'=>'Requerimiento:', 'required', 'max' => '100', 'class'=> 'form-control', 'autofocus','autocomplete'=>'off'],
                                    ['help' => 'Digite el nombre del requerimiento.', 'icon' => 'fa fa-tag'] ) !!}
...
<!-- file script -->
    ...
    jQuery(document).ready(function () {
        ...
        var rules_create_modal = {
            Requerimiento:{required: true, minlength: 3, maxlength: 100, noSpecialCharacters:true, letters:false},
        };
        var message_create_modal = {
            Requerimiento: {noSpecialCharacters: 'Existen caracteres que no son válidos', letters: 'Los numeros no son válidos'},
        };
        ...
        var rules_edit_modal = {
            Requerimiento_edit:{required: true, minlength: 3, maxlength: 100, noSpecialCharacters:true, letters:false},
        };
        var message_edit_modal = {
            Requerimiento_edit: {noSpecialCharacters: 'Existen caracteres que no son válidos', letters: 'Los numeros no son válidos'},
        };
