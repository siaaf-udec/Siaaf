                ...
                <div class="row">
                    <div class="col-md-12">
                     ...
                     {{--   {!! Field:: hidden ('FK_CPP_Id_Proyecto', $infoProyecto[0]['PK_CP_Id_Proyecto'])!!}
                        ...
                        {!! Field::textArea('Alcance',['label' => 'Necesidades:', 'required', 'auto' => 'off', 'max' => '300', "rows" => '2'],
                                        ['help' => 'Escribe el alcance del proyecto.', 'icon' => 'fa fa-quote-right']) !!}

                        {!! Field::textArea('Metodologia',['label' => 'Expectativas:', 'required', 'auto' => 'off', 'max' => '300', "rows" => '2'],
                                        ['help' => 'Escribe el alcance del proyecto.', 'icon' => 'fa fa-quote-right']) !!}
                    </div>
                </div>
            </div>
