                    ...
                    <div class="form-body">
                        ...
                        <h3><i class="fa fa-arrow-right"></i><strong> Informacion del proceso</strong></h3><br>
                            ...
                            <!--div class="col-md-12">
                                {!! Field::textarea(
                                    'memo',
                                    ['label' => 'Mensaje', 'required', 'auto' => 'off', 'max' => '300', "rows" => '1'],
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <br><h3><i class="fa fa-arrow-right"></i><strong>  Requisitos</strong></h3><br>
...
<!-- file script -->
    ...
    jQuery(document).ready(function () {
        ...
        //objetivos
        var objetivos_max = 3;   //maximo de campos
        var x_objetivo = 0;
        $('#agregarObjetivo').click (function(e) {
                ...
                if (x_objetivo < objetivos_max) {
                    ...
                    <input class="form-control form-control" autofocus="" autocomplete="off" maxlength="100" id="requisito_'+x_objetivo+'" name="requisito_'+x_objetivo+'" type="text">\
                    <label for="requisito_'+x_objetivo+'" class="control-label">Objetivo especifico (adicional):</label>\
                    ...
                    xhr = "warning"
                    UIToastr.init(xhr, "¡Lo sentimos!", "Maximo puede agregar "+objetivos_max+" objetivos adicionales.");
                }
        });
        ...
        $('#remover_objetivo').click (function(e) {
            ...
            if(x_objetivo==0){
                ...
                x_objetivo--;
                $("#objetivo"+x_objetivo).slideUp(400, function(){$("#objetivo"+x_objetivo).remove();});
            }
        });
         // Requisitos
        ...
        /*
        // Interesados
        var interesados_max = 3;   //maximo de campos
        var x_interesado = 0;
        $('#agregarInteresado').click (function(e) {
                e.preventDefault();     //prevenir novos clicks
                if (x_interesado < interesados_max) {
                        $('#ListaInteresados').append(' <div class="form-group form-md-line-input">\
                                                        <div class="input-icon col-md-10">\
                                                        <input class="form-control form-control" autofocus="" autocomplete="off" id="campo_" name="campo[]" type="text">\
                                                        <label for="campo_" class="control-label">Nombre del interesado:</label>\
                                                        <span class="help-block"> Digite el nombre del interesado </span>\
                                                        <i class=" fa fa-tag "></i>\
                                                        </div>\
                                                        <a href="#" class="btn btn-outline red remover_interesado"><i class="fa fa-minus-circle"></i></a>\
                                                        </div>');
                    x_interesado++;
                }
        });
        // Remover o div anterior
        $('#ListaInteresados').on("click",".remover_interesado",function(e) {
                e.preventDefault();
