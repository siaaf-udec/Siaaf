    ...
    @component('themes.bootstrap.elements.portlets.portlet', ['icon' => 'icon-book-open', 'title' => 'Formulario de filtrado de un reporte por código.'])
        <div class="row">
            <div class="col-md-7 col-md-offset-2">
                {!! Form::open (['id'=>'form_filtrar_codigo', 'url' => '/forms']) !!}
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        var createAccion = function () {
            return {
                init: function () {
                    var route = '{{ route('parqueadero.reportesCarpark.DescargarfiltradoCodigo') }}';
                    var type = 'POST';
                    ...
                    $.ajax({
                        ...
                        success: function (response, xhr, request) {
                            ...
                            if (request.status === 200 && xhr === 'success') {
                                $('#form_filtrar_codigo')[0].reset(); //Limpia formulario
