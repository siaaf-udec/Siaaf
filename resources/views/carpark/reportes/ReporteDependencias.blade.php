...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            ...
            <div class="date">Total Dependencias: {{$total}}</div>
            <div class="date">Fecha del reporte: {{$date}}</div>
            <div class="date">Hora del reporte: {{$time}}</div>
            <div><a class="noPrint" href="{{ route('parqueadero.reportesCarpark.DescargarReporteDependencia') }}">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <th class="no" >#</th>
            <th class="unit"><b>Código Dependencia</b></th>
            <th class="unit"><b>Nombre Dependencia</b></th>            

        </tr>
        </thead>
        @foreach($infoDependencias as $infoDependencia)
        <tbody>
        <tr>
            <td class="no">{{$cont++}}</td>
            <td class="unit">{{$infoDependencia->PK_CD_IdDependencia}}</td>
            <td class="desc">{{$infoDependencia->CD_Dependencia}}</td>
