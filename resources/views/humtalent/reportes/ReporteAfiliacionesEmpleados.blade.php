...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            ...
            <div><a class="noPrint" href="{{ route('talento.humano.empleado.DownloadPdfAfiliaciones') }}">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <th class="unit"><b>FONDO DE<br> PENSIONES</b></th>
        ...
        <tr>
            ...
            <td class="desc">{{$empleado->PRSN_Eps}}</td>
            <td class="unit">{{$empleado->PRSN_Fpensiones}}</td>
            <td class="desc">{{$empleado->PRSN_Caja_Compensacion}}</td>
