...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            <h1>DATOS DE SALARIO POR ÁREA:</h1>
            ...
            <div><a class="noPrint" href="{{ route('talento.humano.empleado.DownloadPdfSalario1') }}">
    ...
    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="example-table-ajax">
        ...
        <tr>
            ...
            <td class="desc">{{$empleado->PRSN_Salario}}</td>
