...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            ...
            <div><a class="noPrint" href="{{ route('talento.humano.empleado.DownloadPdfContacto') }}">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <th class="unit"><b>CORREO ELECTRÓNICO</b></th>
        ...
        <tr>
            ...
            <td class="desc">{{$empleado->PRSN_Telefono}}</td>
            <td class="unit">{{$empleado->PRSN_Correo}}</td>
