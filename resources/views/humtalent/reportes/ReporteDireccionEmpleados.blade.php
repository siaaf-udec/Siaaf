...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            ...
            <div><a class="noPrint" href="{{ route('talento.humano.empleado.DownloadPdfDireccion') }}">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td class="desc">{{$empleado->PRSN_Direccion}}</td>
            <td class="unit">{{$empleado->PRSN_Ciudad}}</td>
