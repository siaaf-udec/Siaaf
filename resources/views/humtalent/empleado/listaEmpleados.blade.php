...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        columns = [
            ...
            {
                defaultContent: '@permission("TAL_READ_DOC")<a href="javascript:;" class="btn btn-primary documents" ><i class="fa fa-book"></i></a>@endpermission',
                data:'action',
                name:'action',
                title:'Acciones',
                orderable: false,
        ...
        table.on('click', '.documents', function (e) {
            ...
            var dataTable = table.row($tr).data(),
                route = '{{ route('talento.humano.historialDocumentos.documentos') }}'+'/'+dataTable.PK_PRSN_Cedula;
