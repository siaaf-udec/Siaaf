            ...
            <div class="col-md-7 col-md-offset-2">
                <div class="form-body">
                    ...
                    <div class="form-wizard">
                        ...
                        'class'=> 'form-control', 'autofocus', 'maxlength'=>'40','autocomplete'=>'off','required','pattern'=> '[A-Za-zñÑÁáéÉÍíóÓúÚ0-9]+','title'=>'En este campo solo se admiten letras y numeros, sin espacios']
                        ,['help' => 'Modifique el nombre como desee','icon'=>'fa fa-wrench'] ) !!}
                        {!! Field:: textarea('MAN_Descripcion',$tiposMant->MAN_Descripcion,
                        ['label'=>'Digite la nueva descripción del tipo:','class'=> 'form-control', 'rows'=>'3', 'autofocus','autocomplete'=>'off','pattern'=> '[A-Za-zñÑÁáéÉÍíóÓúÚ 0-9]+','title'=>'En este campo solo se admiten letras y numeros, con espacios'],
