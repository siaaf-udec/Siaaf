...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            ...
            <div><a class="noPrint" href="{{ route('audiovisuales.DownloadTiempoUso') }}">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <th class="no" >#</th>
            <th class="unit"><b>TIPO ARTICULO</b></th>
            <th class="unit"><b>DESCRIPCIÓN</b></th>
            <th class="unit"><b>TIEMPO USO</b></th>
        ...
        <tr>
            <td class="no">{{$cont++}}</td>
            <td class="desc">{{$empleado->FK_ART_Tipo_id}}</td>
            <td class="desc">{{$empleado->ART_Descripcion}}</td>
            <td class="unit">{{$empleado->ART_Codigo}}</td>
