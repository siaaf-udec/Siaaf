...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            ...
            <div class="date">Fecha del reporte: </div>
            <div class="date">Hora del reporte: </div>
...
<script>
    $(document).ready(function () {
        var sec = JSON.parse('<?php echo json_encode($serie) ?>');
        ...
        var title = {
            text: 'Reporte Uso Elementos Por Programa '
        };
        var subtitle = {
        ...
        $(".enviar").on('click', function (e) {
            var route = '{{ route('audiovisuales.DownloadPdfCarreras') }}';
            location.href = route;
        });
