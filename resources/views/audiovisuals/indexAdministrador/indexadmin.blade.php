...
<link href="{{ asset('assets/pages/css/ticket.min.css') }}" rel="stylesheet" type="text/css"/>
<!-- Styles DATATABLE  -->
        ...
        <div class="profile-sidebar">
            ...
            <div class="portlet light profile-sidebar-portlet ">
                ...
                <div class="profile-userpic">
                    <img alt="" class="img-responsive" src="../assets/pages/media/profile/profile_user.jpg">
                    </img>
                </div>
                <!-- END SIDEBAR USERPIC -->
                <!-- SIDEBAR USER TITLE -->
...
@push('plugins')
<script src="{{-- {{ asset('ruta/del/archivo/js') }} --}}" type="text/javascript">
</script>
<!-- BEGIN CORE PLUGINS -->
<script src="{{ asset('assets/global/scripts/app.min.js') }}" type="text/javascript">
</script>
<script src="{{ asset('assets/pages/scripts/profile.min.js') }}" type="text/javascript">
</script>
...
{{--
<script src="../assets/layouts/layout2/scripts/layout.min.js" type="text/javascript">
</script>
<script src="../assets/layouts/layout2/scripts/demo.min.js" type="text/javascript">
</script>
...
<script>
    ...
    //         });
    //     })
    document.getElementsByClassName('page-bar')[0].style.visibility = 'hidden';
</script>
@endpush
