        ...
        <vue-modal id="modal-faq" modal-class="container" title="¿Qué puedo hacer?">
            <template slot="body">
                <div class="col-md-12 text-center">
                    <youtube video-id="_7tUK8vvhlU" ></youtube>
...
<script>
    ...
    export default {
        name: "student-validation-request-index",
            ...
            return {
                portlet: {
                    ...
                    action: {
                        ...
                        link: route('financial.requests.student.validation.create'),
                    },
                    button: {
                        link: route('financial.requests.student.validation.create'),
                        tooltip: Lang.get('javascript.tooltip.add'),
                ...
                url: route('financial.api.datatables.validation', {}, false),
                source: [
                    { data: 'id',               name: 'id' },
        ...
        methods: {
            ...
            destroy: function( table ) {
                ...
                table.on('click', '.trash', function (e) {
                    ...
                    let $url = route('financial.requests.student.validation.destroy', { id: $(this).data('id')});
                    swal({
