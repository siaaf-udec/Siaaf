        ...
        <div class="col-md-12">
            <portlet icon="icon-layers" :title="portlet.title">
                <template slot="body">
                    <div class="row">
                        <div class="col-md-12">
                            <form @submit.prevent="createExtension" id="financial-form-extension" role="form" :action="portlet.route" method="post">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
...
<script>
    ...
    export default {
        name: "student-extension-request-create",
        ...
        data: () => {
            return {
                portlet: {
                    ...
                    route: route('financial.requests.student.extension.store'),
                    select: {
        ...
        methods: {
            initValidation: function () {
                $('#financial-form-extension').validate();
            },
            ...
            createExtension: function () {
                if ($('#financial-form-extension').valid()) {
                    this.vueLoading();
