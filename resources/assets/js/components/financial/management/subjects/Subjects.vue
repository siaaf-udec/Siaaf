        ...
        data: function () {
            return {
                ...
                tableAssigned: {
                    ...
                    source: [
                        { data: 'subjects[0].subject_code', name: 'subjects[0].subject_code' },
                        { data: 'subjects[0].subject_name', name: 'subjects[0].subject_name' },
                        { data: 'subjects[0].subject_credits', name: 'subjects[0].subject_credits' },
                        { data: 'programs[0].program_name',        name: 'programs[0].program_name' },
                        { data: 'teachers[0].full_name', name: 'teachers[0].full_name' },
                        { data: 'actions', name: 'actions', searchable: false, orderable: false },
                    ],
                },
                buttons: {
