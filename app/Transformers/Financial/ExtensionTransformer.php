...
class ExtensionTransformer extends TransformerAbstract
{
    ...
    public function transform( Extension $extension )
    {
        return [
            ...
            'subject_id'        =>  isset( $extension->subject->{ primaryKey() } ) ? $extension->subject->{ primaryKey() } : 0,
            ...
            'program_id'        =>  isset( $extension->subject->programs[0]->{ primaryKey() } ) ? $extension->subject->programs[0]->{ primaryKey() } : 0,
            ...
            'cost_float'        =>  isset( $extension->cost->cost ) ? $extension->cost->cost : 0,
