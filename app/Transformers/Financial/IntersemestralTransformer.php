...
class IntersemestralTransformer extends TransformerAbstract
{
    ...
    public function transform( Intersemestral $intersemestral )
    {
        ...
        return [
            ...
            'subject_id'        =>  isset( $intersemestral->subject->{ primaryKey() } ) ? $intersemestral->subject->{ primaryKey() } : 0,
            ...
            'program_id'        =>  isset( $intersemestral->subject->programs[0]->{ primaryKey() } ) ? $intersemestral->subject->programs[0]->{ primaryKey() } : __('financial.generic.empty'),
            ...
            'cost_float'        =>  isset( $intersemestral->cost->cost ) ? $intersemestral->cost->cost : 0,
