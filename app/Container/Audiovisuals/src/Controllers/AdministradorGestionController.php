               ...
               // $array = json_decode($array);
                ...
                return DataTables::of($array)
                    ->addColumn('Elementos', function ($solicitudes) {
                        if ($solicitudes->PRT_FK_Kits_id != 0) {
                            return "Kit";
                        } else {
                            return "Articulos";
                        }
                    ...
                    ->addColumn('Acciones', function ($solicitudes) {
                        ...
                        if( ($fechaHoy >= $fechaReserva)  &&  ($fechaHoy <= $fechaFin) ){
                            if ($solicitudes->PRT_Observacion_Entrega == '') {
                            ...
                            if($fechaHoy <= $fechaReserva  ){
                                return "<a class='btn btn-simple btn-info btn-icon noDisponible' id='1'><i class=\"icon-list\"></i>No disponible</a>";
                            }
                            if($fechaHoy > $fechaFin){
                               // $sancion = true;
                                return "<a class='btn btn-simple btn-info btn-icon aplicarSancion' id='1'><i class=\"icon-list\"></i>Aplicar Sancion</a>";
                            }
                        }
                       // if(!$sancion){
                           // return "<a class='btn btn-simple btn-info btn-icon aplicarSancion' id='4'><i class=\"icon-list\"></i>Aplicar Sancion</a>";
                       // }
                    })
                    ->rawColumns(['Acciones'])
                    ->addIndexColumn()
