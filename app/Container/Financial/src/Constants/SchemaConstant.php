...
class SchemaConstant
{
     ...
     * @return array
     */
    public static function getFillables( $key )
    {

        switch ($key) {
            case self::INTERSEMESTRAL_STUDENT    :
                return [
                ];
                break;
            case self::INTERSEMESTRAL            :
                return [
                ];
                break;
            case self::EXTENSION                 :
                return [
                    ...
                    self::SUBJECT_FOREIGN_KEY,
                    self::STUDENT_FOREIGN_KEY,
                    self::STATUS_FOREIGN_KEY,
                    self::COST_FOREIGN_KEY,
                ];
                break;
            case self::ADD_SUB_SUBJECTS          :
                return [
                ];
                break;
