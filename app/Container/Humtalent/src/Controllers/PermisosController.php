...
class PermisosController extends Controller
{
    ...
    public function listaPermisos($id){  //función que presenta la  vista con lista de los permisos, en un data table  relacionados con el empleado seleccionado,recibe el id del empleado
    ...
    public function store(Request $request){ //función que registra un permiso a travez de un formulario
        ...
        $notification=array( //se retorna un mensaje de notificación
            'message'=>'La información del permiso fue almacenada',
            'alert-type'=>'success'
        );
    ...
    public function update(Request $request){ //función que actualiza los datos de un permiso seleccionado
        ...
        $permiso->save();
        $notification=array(
            'message'=>'La información del permiso fue modificada',
            'alert-type'=>'success'
        );
        return back()->with($notification);
    }
