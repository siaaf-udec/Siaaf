...
Route::namespace('Files')->prefix('gestion-de-archivos')->group(function () {
    Route::prefix('solicitudes')->group(function () {
         ...
         */
        Route::resource('estudiantes', 'FileController', [
         ...
         */
        Route::resource('aprobaciones', 'ManagementController', [
            'only'  =>  ['index', 'update'],
            'names' => [
...
Route::namespace('Management')->prefix('recursos')->group( function () {
     ...
     * Approval Management
     */
    Route::resource('programas', 'ManageProgramsController', [
     ...
     * Approval Management
     */
    Route::resource('materias', 'ManageSubjectsController', [
        'only'  =>  ['index', 'store', 'update', 'destroy'],
        'names' => [
     ...
     */
    Route::resource('materias-programas-docentes', 'ManageSubjectProgramTeacherController', [
        'only'  =>  ['index', 'store'],
        'names' => [
    ...
    Route::put('materias-programas-docentes', 'ManageSubjectProgramTeacherController@update')
        ->name('financial.management.subjects.programs.teachers.update');
    Route::delete('materias-programas-docentes', 'ManageSubjectProgramTeacherController@destroy')
        ->name('financial.management.subjects.programs.teachers.destroy');

    /**
     * Status Request Management
     */
    Route::resource('estados-de-solicitudes', 'ManageStatusController', [
        'only'  =>  ['index', 'store', 'update', 'destroy'],
        'names' =>  [
     ...
     * Costs Management
     */
    Route::resource('costos-solicitudes', 'ManageCostController', [
        'only'  =>  ['index', 'store', 'update', 'destroy'],
        'names' =>  [
     ...
     */
    Route::resource('tipos-de-archivos', 'ManageFileTypesController', [
        'only'  =>  ['index', 'store', 'update', 'destroy'],
        'names' =>  [
