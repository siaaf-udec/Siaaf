...
(function () {
    ...
    var Q = function (a) {
        ...
        S = function (a, b) {
            if (b)
                for (var c in b) b.hasOwnProperty(c) && (a[c] && b[c] && "object" === typeof a[c] && "object" === typeof b[c] && !eb(a[c]) && !eb(b[c]) ? S(a[c], b[c]) : b[c] && "object" === typeof b[c] ? (a[c] = eb(b[c]) ? [] : {}, S(a[c], b[c])) : a[c] = b[c])
        },
        fb = function (a) {
            if (a && !/^\s+$/.test(a)) {
                for (; 0 ==
    ...
    var V = function () {
        ...
        this.v = [];
        this.v[0] = 128;
        for (var a = 1; a < this.c; ++a) this.v[a] = 0;
        this.w = this.j = 0;
        this.reset()
    };
    (function () {
    ...
    V.prototype.update = function (a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (var c = b - this.c, d = 0, e = this.B, f = this.j; d < b;) {
                if (0 == f)
                    for (; d <= c;) Ab(this, a, d), d += this.c;
                if ("string" == typeof a)
                    for (; d < b;) {
                        if (e[f] = a.charCodeAt(d), ++f, ++d, f == this.c) {
                            Ab(this, e);
                            f = 0;
                            break
                        }
    ...
    V.prototype.digest = function () {
        var a = [],
            b = 8 * this.w;
        56 > this.j ? this.update(this.v, 56 - this.j) : this.update(this.v, this.c - (this.j - 56));
        for (var c = this.c - 1; 56 <= c; c--) this.B[c] = b & 255, b /= 256;
        Ab(this, this.B);
        for (c = b = 0; 5 > c; c++)
        ...
        yc = function (a, b, c, d) {
            ...
            if (Ac(vc || {}))
                for (var t in c) {
                    ...
                    d = [];
                    for (t in c)
                        for (a = c[t], u = 0, b = a.length; u < b; u++) e = a[u], Cc(t, e, rc(e), d, b);
                    Dc(q, d)
                }
        },
        Ec = function (a) {
                ...
                if ("_renderstart" === d.s || d.s === Oc + "/" + e + "::_renderstart") {
                    ...
                    if (f && c && f.width && f.height) {
                        a: {
                            ...
                            var f = e.width,
                                k = e.height,
                                h = d.style;h.textIndent = "0";h.margin = "0";h.padding = "0";h.background = "transparent";
                            h.borderStyle = "none";h.cssFloat = "none";h.styleFloat = "none";h.lineHeight = "normal";h.fontSize = "1px";h.verticalAlign = "baseline";d = d.style;d.display = "inline-block";h = c.style;h.position = "static";h.left = 0;h.top = 0;h.visibility = "visible";f && (d.width = h.width = f + "px");k && (d.height = h.height = k + "px");e.verticalAlign && (d.verticalAlign = e.verticalAlign);g && tb(g, 3)
                        }
        ...
        Zc = function () {
            ...
            Xc.iterate(function (c, d) {
                if (0 === c.indexOf("G_AUTHUSER_")) {
                    ...
                    if (!a || e.g && !a.g || e.g == a.g && e.i > a.i) a = e, b = d
                }
            });
            return {
                W: a,
    ...
    _c: {
        "jsl": {
            "ci": {
                ...
                "lexps": [81, 97, 100, 122, 124, 45, 30, 79, 127],
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.vi.9yo_qFdvTfg.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCPf61k6Zsrk2WXH4Ztr_5WV1Zw_ZQ",
            "u": "https://apis.google.com/js/plusone.js",
            "hee": true,
            "fp": "8f2a6583385d207d410b5aca9dbce4143eaeea10",
            "dpo": false
        },
        "platform": ["additnow", "backdrop", "blogger", "comments", "commentcount", "community", "follow", "page", "person", "playreview", "plus", "plusone", "post", "reportabuse", "savetodrive", "savetowallet", "shortlists", "signin2", "udc_webconsentflow", "visibility", "youtube", "ytsubscribe", "zoomableimage", "hangout", "sharetoclassroom"],
        "fp": "8f2a6583385d207d410b5aca9dbce4143eaeea10",
