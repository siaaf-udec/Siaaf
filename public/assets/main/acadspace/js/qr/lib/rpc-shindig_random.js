...
(function () {
    var f = window,
        ...
        C = function () {
            var a;
            if ((a = Object.create) && u.test(a)) a = a(null);
            else {
                a = {};
    ...
    P.push(["jsl", function (a) {
        for (var b in a)
            if (Object.prototype.hasOwnProperty.call(a, b)) {
                var c = a[b];
                "object" == typeof c ? E[b] = w(E, b, []).concat(c) : w(E, b, c)
            }
    ...
    var ba = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        ia = function (a, b, c, d) {
            var e = a.split(";"),
                ...
                l = O[g],
                k = null;
            l ? k = l(e, b, c, d) : Q("no hint processor for: " + g);
            k || Q("failed to generate load url");
            b = k;
            c = b.match(fa);
            (d = b.match(ga)) && 1 === d.length && ha.test(b) && c && 1 === c.length || Q("failed sanity: " + a);
            return k
        },
        ka = function (a, b, c, d) {
            a = ja(a);
            da.test(c) || Q("invalid_callback");
            b = R(b);
            d = d && d.length ? R(d) : null;
            var e = function (a) {
        ...
        ja = function (a) {
            ...
            for (var d = 0, e = b.length; d < e; ++d) {
                ...
                2 == g.length && l && k && (a[l] = a[l] || k)
            }
            b = "/" + c.join("/");
            ba.test(b) || Q("invalid_prefix");
            c = S(a, "k", !0);
            d = S(a, "am");
            e = S(a, "rs");
            a = S(a, "t");
    ...
    O.m = function (a, b, c, d) {
        ...
        return "https://apis.google.com" + ka(a, b, c, d)
    };
    var U = decodeURI("%73cript"),
        ...
        W = function (a) {
            var b = h.createElement(U);
            b.setAttribute("src", a);
            b.async = "true";
            (a = h.getElementsByTagName(U)[0]) ? a.parentNode.insertBefore(b, a): (h.head || h.body || h.documentElement).appendChild(b)
        },
        na = function (a, b) {
            var c = b && b._c;
            if (c)
        ...
        Z = function (a, b) {
            ...
            if (g["::"] && d.length) {
                ...
                if (1 <
                    z) {
                    var v = c.callback;
                    v && (c.callback = function () {
                        0 == --z && v()
                    })
                }
                for (; d = l.shift();) Y(d.b, c, d.hint)
            } else Y(d || [], c, e)
        },
        Y = function (a, b, c) {
            a = B(a) || [];
            var d = b.callback,
                ...
                k = b.onerror,
                q = void 0;
            "function" == typeof k && (q = k);
            var x = null,
                y = !1;
            if (g && !l || !g && l) throw "Timeout requires both the timeout parameter and ontimeout parameter to be set";
            var k = w(H(c), "r", []).sort(),
                z = w(H(c), "L", []).sort(),
                v = [].concat(k),
                T = function (a, b) {
...
gapi.load("rpc:shindig_random", {
    ...
    _c: {
        "jsl": {
            ...
            "u": "https://apis.google.com/js/rpc:shindig_random.js?onload\u003dinit",
            "hee": true,
